...
/**
 * @Author beaker
 * @Date 2026/3/26 19:21
 * @Description 总结输出
 */
@Service
@Slf4j
public class LogExecutionSummeryNode extends AbstractExecuteSupport{
    @Override
    ...
    private void generateFinalReport(ExecuteCommandEntity requestParameter, DefaultAutoAgentExecuteStrategyFactory.DynamicContext dynamicContext) {
        try {
            ...
            AiAgentClientFlowConfigVO aiAgentClientFlowConfigVO = dynamicContext
                    .getAiAgentClientFlowConfigVOMap().get(AiClientTypeEnumVO.RESPONSE_ASSISTANT.getCode());
